...
void loop()
{
  ...
  lcd.setCursor(0,1);
if (digitalRead(out1) && !bol1) 
{   
  //lcd.clear();          
  lcd.print("op1");
}
if (digitalRead(out2) && !bol2) 
{
  //lcd.clear();
  lcd.print("op2");
}
if (digitalRead(out3) && !bol3)
{ 
  //lcd.clear();
  lcd.print("op3");
}
if (digitalRead(out4) && !bol4) 
{
  //lcd.clear();
lcd.print("op4");
}
if ((digitalRead(out1) && bol1) || (digitalRead(out2) && bol2) || (digitalRead(out3) && bol3) || (digitalRead(out4) && bol4)){   
  lcd.setCursor(0,0);                        
